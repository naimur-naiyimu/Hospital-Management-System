...
class User(AbstractBaseUser, PermissionsMixin):
    user_type = models.PositiveSmallIntegerField(choices=constants.USER_TYPE_CHOICES.choices, default=2)
    patient = models.ForeignKey('patient.Patient', on_delete=models.CASCADE, blank = True, null = True)
    doctor = models.ForeignKey('staff.Doctor',on_delete=models.CASCADE,  blank = True, null = True)
    ...
    country = models.CharField(default='Bangladesh', max_length= 100, blank=True)
